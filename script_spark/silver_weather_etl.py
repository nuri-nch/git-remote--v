...
from pyspark.sql.functions import col, from_unixtime, year, month, input_file_name, regexp_extract, lower, lit
...
df_hist_norm = df_hist_norm.withColumn("pressure", lit(None).cast("integer")) \
